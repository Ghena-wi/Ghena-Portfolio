  ...
  <nav class="navbar navbar-light navbar-expand-md bg-light navigation-clean" style="background-color: rgba(255,255,255,0)!important;opacity: 1;margin: 0px;">
      ...
      <span class="text-uppercase font-weight-bold"></span></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1" style="color: white!important;"><span class="sr-only" style="color: rgb(255,255,255);">Toggle navigation</span><span class="navbar-toggler-icon" style="color: rgb(248,248,248)!important;filter: brightness(115%) contrast(74%);"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav text-left">
                             ...
                             <!-- <li class="nav-item text-right" role="presentation" style="font-size: 25px;"><a class=" btn btn-link " href="application2.php?la=ar" style="color: rgb(255,255,255);font-family: Cairo, sans-serif;font-size: 20px;">العربية</a></li> -->
        ...
        >?</button>
                   ...
                   <div class="form-group text-left"><label style="color: #282821;">Country</label>
                          <input class="form-control text-left" type="text" name="Country1" required="" placeholder="Country"> 
                                    ...
                                    <div class="form-group text-left"><label style="color: #282821;">Address</label><input class="form-control text-left" type="text" name="city1" required="" placeholder="City ">
                                                 </div><div class="form-group text-right">
                                      <input class="form-control text-left" type="text" name="postal1" placeholder="Zip code "  required="" ></div>
                                    <div style="height: 33px;"></div>
                    ...
                    <div class="form-group text-left"><label style="color: #282821;">Country</label>
                         ...
                         <div class="card">
                                ...
                                <div class="collapse item-3" role="tabpanel" data-parent="#accordion-1">
                                    <div class="card-body">
                                        <div class="form-group text-left"><label style="color: #282821;">
                                        Student name</label><input class="form-control text-left" type="text" name="first_name3" required="" placeholder="First name"></div>
                     ...
                     <div class="form-group text-left"><label style="color: #282821;">Country</label>
                          <input class="form-control text-left" type="text" name="Country3" required="" placeholder="Country"> 
                                    ...
                                    <div class="form-group text-left"><label style="color: #282821;">Address</label><input class="form-control text-left" type="text" name="city3" required="" placeholder=" City">              </div><div class="form-group text-right">
                                      <input class="form-control text-left" type="text"  required=""  name="postal3" placeholder=" Zip code "></div>
                                    <div style="height: 33px;"></div>
    ...
    <div class="text-center" style="background-color: rgb(45,80,111)!important;height: auto;margin-bottom: 0px; padding:30px;padding-bottom: 1rem!important; padding-top: 2rem!important;">
             ...
             <a><p class="text-center" style="font-family: Cairo, sans-serif;font-size: 16px; color: rgb(255,255,255);">info@onlinefse.com</p></a>
              ...
              <a class="nav-link" href="" style="font-size: 17px;    display: inline-flex;"><i class="fab fa-facebook-square" style="color: rgb(255,255,255); padding-right:10px;    padding-top: 3px; "></i> <p style="font-size: 15px;  color: rgb(255,255,255);">Fun Size English </p> </a>
                      ...
                      <div> <a href="tel:+1 352-345-5053" ><i class="fa fa-whatsapp" style=" color:rgb(74,201,89);font-size: 19px; display: inline-block;padding-right:7px;  "> </i> <p style="font-size: 15px;    display: inline-flex; color: rgb(255,255,255);">+1 343-297-6871 </p></a></div>
                            <hr>  <div>
              <p  style="padding-left: 0px;color: rgb(255,255,255); display: inline-flex;margin-top:15px;">Fun Size English 2023</p>
        </div></div> 
</body>
...
$(document).ready(function(){
    $("#advancedPop button").popover({
        title : ' Advanced level',
            html: true,
        template: '<div class="popover"><div class="arrow"></div><h3 class="popover-header text-left"></h3><div class="popover-body text-justify-start"></div></div>'
    });
