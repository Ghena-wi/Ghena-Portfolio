...
$_SESSION["chosen_level4"] = $_POST['chosen_level4'];
$_SESSION["postal4"] = $_POST['postal4'];



//student 5
$_SESSION["first_name5"] = $_POST['first_name5'];
$_SESSION["last_name5"] = $_POST['last_name5'];
$_SESSION["date_of_birth5"] = $_POST['bday5'];
$_SESSION["city5"] = $_POST['city5'];
$_SESSION["Country5"] = $_POST['Country5'];
$_SESSION["email5"] = $_POST['email5'];
$_SESSION["gender5"] = $_POST['gender5'];
$_SESSION["phone_num5"] = $_POST['phone_num5'];
$_SESSION["postal5"] = $_POST['postal5'];



//student 6

$_SESSION["first_name6"] = $_POST['first_name6'];
$_SESSION["last_name6"] = $_POST['last_name6'];
$_SESSION["date_of_birth6"] = $_POST['bday6'];
$_SESSION["city6"] = $_POST['city6'];
$_SESSION["Country6"] = $_POST['Country6'];
$_SESSION["email6"] = $_POST['email6'];
$_SESSION["gender6"] = $_POST['gender6'];
$_SESSION["phone_num6"] = $_POST['phone_num6'];
$_SESSION["postal6"] = $_POST['postal6'];



//student 7
$_SESSION["first_name7"] = $_POST['first_name7'];
$_SESSION["last_name7"] = $_POST['last_name7'];
$_SESSION["date_of_birth7"] = $_POST['bday7'];
$_SESSION["city7"] = $_POST['city7'];
$_SESSION["Country7"] = $_POST['Country7'];
$_SESSION["email7"] = $_POST['email7'];
$_SESSION["gender7"] = $_POST['gender7'];
$_SESSION["phone_num7"] = $_POST['phone_num7'];
$_SESSION["postal7"] = $_POST['postal7'];



//student 8
$_SESSION["first_name8"] = $_POST['first_name8'];
$_SESSION["last_name8"] = $_POST['last_name8'];
$_SESSION["date_of_birth8"] = $_POST['bday8'];
$_SESSION["city8"] = $_POST['city8'];
$_SESSION["Country8"] = $_POST['Country8'];
$_SESSION["email8"] = $_POST['email8'];
$_SESSION["gender8"] = $_POST['gender8'];
$_SESSION["phone_num8"] = $_POST['phone_num8'];
$_SESSION["chosen_level8"] = $_POST['chosen_level8'];
$_SESSION["postal8"] = $_POST['postal8'];



	header("Location: application3paymenten.php");
?>